...
-- Dependencies: 225
-- Data for Name: chatmessage; Type: TABLE DATA; Schema: dave; Owner: dave
--

COPY dave.chatmessage (id, created_time, version, content, participant_id, "timestamp", type, uploaded, viewed, zaehlung_id) FROM stdin;
\.


--
-- TOC entry 4864 (class 0 OID 16535)
-- Dependencies: 226
-- Data for Name: dienstleister; Type: TABLE DATA; Schema: dave; Owner: dave
--

COPY dave.dienstleister (id, created_time, version, active, kennung, name) FROM stdin;
\.


--
-- TOC entry 4865 (class 0 OID 16542)
-- Dependencies: 227
-- Data for Name: dienstleister_emailaddresses; Type: TABLE DATA; Schema: dave; Owner: dave
--

COPY dave.dienstleister_emailaddresses (dienstleister_id, email_addresses) FROM stdin;
\.


--
-- TOC entry 4866 (class 0 OID 16545)
-- Dependencies: 228
-- Data for Name: emailaddress; Type: TABLE DATA; Schema: dave; Owner: dave
--

COPY dave.emailaddress (id, created_time, version, email_address, participant_id) FROM stdin;
\.


--
-- TOC entry 4867 (class 0 OID 16550)
-- Dependencies: 229
-- Data for Name: hochrechnungsfaktor; Type: TABLE DATA; Schema: dave; Owner: dave
--

COPY dave.hochrechnungsfaktor (id, created_time, version, active, default_faktor, gv, kfz, matrix, sv) FROM stdin;
\.


--
-- TOC entry 4868 (class 0 OID 16555)
-- Dependencies: 230
-- Data for Name: infomessage; Type: TABLE DATA; Schema: dave; Owner: dave
--

COPY dave.infomessage (id, created_time, version, aktiv, content, gueltig_bis, gueltig_von) FROM stdin;
\.


--
-- TOC entry 4869 (class 0 OID 16562)
-- Dependencies: 231
-- Data for Name: pkweinheit; Type: TABLE DATA; Schema: dave; Owner: dave
--

COPY dave.pkweinheit (id, created_time, version, busse, fahrradfahrer, kraftraeder, lastzuege, lkw, pkw) FROM stdin;
\.
...
-- Dependencies: 232
-- Data for Name: shedlock; Type: TABLE DATA; Schema: dave; Owner: dave
--

COPY dave.shedlock (name, lock_until, locked_at, locked_by) FROM stdin;
\.


--
-- TOC entry 4871 (class 0 OID 16574)
-- Dependencies: 233
-- Data for Name: zeitintervall; Type: TABLE DATA; Schema: dave; Owner: dave
--

COPY dave.zeitintervall (id, created_time, version, busse, endeuhrzeit, fahrbeziehung_fahrbewegungkreisverkehr, fahrbeziehung_nach, fahrbeziehung_von, fahrbeziehung_id, fahrradfahrer, fussgaenger, hochrechnung_faktorgv, hochrechnung_faktorkfz, hochrechnung_faktorsv, hochrechnung_hochrechnunggv, hochrechnung_hochrechnungkfz, hochrechnungrad, hochrechnung_hochrechnungsv, kraftraeder, lastzuege, lkw, pkw, sortingindex, startuhrzeit, type, zaehlung_id) FROM stdin;
\.
