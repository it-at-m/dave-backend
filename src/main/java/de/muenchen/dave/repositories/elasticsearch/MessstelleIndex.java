...
public interface MessstelleIndex extends ElasticsearchRepository<Messstelle, String> {
    ...
    @CacheEvict(value = { CachingConfiguration.SUCHE_ERHEBUNGSSTELLE, CachingConfiguration.SUCHE_ZAEHLSTELLE_DATENPORTAL,
    ...
    Optional<Messstelle> findByMessquerschnitteId(String id); // TODO: needed?
}
