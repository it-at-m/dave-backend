...
public class AuswertungVisumService {
     ...
     * <p>
     * Für eine Kreuzung wird eine FahrbeziehungVisum für den Von-Knotenarm nach alle Knotenarme und ein zweite FahrbeziehungVisum für alle Knotenarme zum
    ...
    /**
     * Diese Methode erstellt die Optionen zur extraktion der Daten in Methode {@link AuswertungVisumService#ladeZaehldaten(FahrbeziehungVisumDTO, Zaehlung)}.
     *
    ...
    /**
     * Diese Methode ermittelt für den in den Parametern angegeben Monatszeitraum die durchgeführten Zählungen je Zählstelle. Je relevante Fahrbeziehung werden
     * die Zahldaten an die Zählung angehangen. Für eine Kreuzung werden die Fahrbeziehung "x nach alle" und "alle nach x" betrachtet. Der Kreisverkehr
    ...
    /**
     * Diese Methode holt die Zeitintervalle aus der Datenbank und gibt diese als Zaehldaten im Objekt fahrbeziehungVisum zurück.
     *
