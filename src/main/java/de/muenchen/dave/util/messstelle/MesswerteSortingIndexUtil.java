...
public final class MesswerteSortingIndexUtil {
     ...
     * @return 0 falls der LadeMesswerteDTO nicht in einem {@link Zeitblock} vorkommt,
     ...
     *
     * @param ladeMesswerteDto Das LadeMesswerteDTO für den der Index ermittelt werden soll.
     * @return 0 falls der LadeMesswerteDTO nicht in einen entsprechenden {@link Zeitblock}
     ...
     *
     * @return 0 falls der LadeMesswerteDTO nicht als Zeitblock oder normaler Intervall
     ...
     *
     * @param ladeMesswerteDto Das LadeMesswerteDTO für den der Index ermittelt werden soll.
     * @return 0 falls der LadeMesswerteDTO nicht als normaler Intervall
     *         interpretiert werden kann. Ansonsten der entsprechende Indexsummand.
     */
