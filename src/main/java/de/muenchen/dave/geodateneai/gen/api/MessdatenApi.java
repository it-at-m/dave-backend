...
public class MessdatenApi {
     ...
     * 
     * <p><b>200</b> - Messdaten erfolgreich abgefragt.
    ...
    private ResponseSpec getMessdatenRequestCreation(GetMessdatenRequest getMessdatenRequest) throws WebClientResponseException {
        ...
        if (getMessdatenRequest == null) {
            throw new WebClientResponseException("Missing the required parameter 'getMessdatenRequest' when calling getMessdaten", HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        ...
        return apiClient.invokeAPI("/messdaten", HttpMethod.POST, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
     ...
     * 
     * <p><b>200</b> - Summe der Messdaten erfolgreich abgefragt.
     * <p><b>500</b> - Bei der Erstellung oder Durchführung des Requests ist ein Fehler aufgetreten.
     * @param getMessdatenRequest The getMessdatenRequest parameter
     * @return List&lt;MessdatenDto&gt;
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
    ...
    private ResponseSpec getMessdatenSummeRequestCreation(GetMessdatenRequest getMessdatenRequest) throws WebClientResponseException {
        ...
        // verify the required parameter 'getMessdatenRequest' is set
        if (getMessdatenRequest == null) {
            throw new WebClientResponseException("Missing the required parameter 'getMessdatenRequest' when calling getMessdatenSumme", HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        ParameterizedTypeReference<MessdatenDto> localVarReturnType = new ParameterizedTypeReference<MessdatenDto>() {};
        return apiClient.invokeAPI("/messdaten/summe", HttpMethod.POST, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
