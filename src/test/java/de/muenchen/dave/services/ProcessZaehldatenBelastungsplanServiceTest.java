...
public class ProcessZaehldatenBelastungsplanServiceTest {
    ...
    public void getBelastunsplanData() {
        final Map<Fahrbeziehung, ProcessZaehldatenBelastungsplanService.TupelTageswertZaehldatum> zaehldatenJeFahrbeziehung =
                new HashMap<>();
        ...
        final Map<Fahrzeug, BelastungsplanDataDTO> belastungsplanData = new ProcessZaehldatenBelastungsplanService(null, null, null).getBelastungsplanData(zaehldatenJeFahrbeziehung, zaehlung);
    ...
    void calculateDifferenzdatenDTO() {
        ...
        assertThat(calculated.getStreets(), is(new String[]{"Arnulfstraße", "Joseph-Spital-Straße", "Sonnenstraße", null, "Abengauerweg", null, "Joseph-Spital-Straße", null}));

        // value1 === value2 === value3
        assertThat(calculated.getValue1().getSumIn(), is(new BigDecimal[]{BigDecimal.valueOf(10), BigDecimal.valueOf(20), BigDecimal.valueOf(30), BigDecimal.valueOf(40), BigDecimal.valueOf(50), BigDecimal.valueOf(60), BigDecimal.valueOf(70), BigDecimal.valueOf(80)}));
        assertThat(calculated.getValue1().getSumOut(), is(new BigDecimal[]{BigDecimal.valueOf(-2), BigDecimal.valueOf(-14), BigDecimal.valueOf(-26), BigDecimal.valueOf(-38), BigDecimal.valueOf(-50), BigDecimal.valueOf(-62), BigDecimal.valueOf(-74), BigDecimal.valueOf(-86)}));
        assertThat(calculated.getValue1().getSum(), is(new BigDecimal[]{BigDecimal.valueOf(-8), BigDecimal.valueOf(-6), BigDecimal.valueOf(-4), BigDecimal.valueOf(-2), BigDecimal.valueOf(0), BigDecimal.valueOf(2), BigDecimal.valueOf(4), BigDecimal.valueOf(6)}));
    }
