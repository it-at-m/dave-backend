...
class FillPdfBeanServiceTest {
    ...
    public void createChartTitleGanglinieDatentabelle() {
        ...
        assertThat(FillPdfBeanService.createChartTitleVerkehrsbeziehung(optionsDTO, zaehlung), is("Zählstelle - Teilauswahl"));
        ...
        assertThat(FillPdfBeanService.createChartTitleVerkehrsbeziehung(optionsDTO, zaehlung), is("Gesamte Zählstelle"));
        optionsDTO.setChosenVerkehrsbeziehungen(null);
        ...
        assertThat(FillPdfBeanService.createChartTitleVerkehrsbeziehung(optionsDTO, zaehlung), is("Gesamte Zählstelle"));
        optionsDTO.setChosenLaengsverkehre(null);
    ...
    void fillMessstelleninformationenGesamtauswertung() {
        ...
        optionsDTO.setFahrzeuge(new FahrzeugOptionsDTO());
    ...
    @Test
    void getSelectedFahrzeugeAsText() {
        final String expected = "Lkw, Lz, Krad";
        ...
        fahrzeugOptionsDTO.setKraftraeder(true);
        assertThat(FillPdfBeanService.getSelectedFahrzeugeAsText(fahrzeugOptionsDTO), is(expected));
    }
}
