...
public class FillPdfBeanServiceSpringTest {
    ...
    public void fillBelastungsplanPdf() throws DataNotFoundException {
        ...
        assertThat(diagrammPdf.getDocumentTitle(), is("Belastungsplan - Zählstelle 133301"));
